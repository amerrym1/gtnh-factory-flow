...
export async function GET() {
  ...
  const lines = [
    ...
    "Key facts:",
    "",
    "- Carries full recipe data for GTNH 2.8 and 2.9, exported from the game itself (NEI/RecEx), including multiblock machines, ore dictionary alternatives, and programmed circuit settings.",
