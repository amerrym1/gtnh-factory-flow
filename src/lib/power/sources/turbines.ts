...
const SPECS: TurbineSpec[] = [
  {
    ...
    unlock: "HV",
    blurb: "The workhorse: steam in, EU out, rotor sets everything.",
    turbineClass: "steam",
    xl: false,
    steamGrade: "Steam",
  },
  {
    ...
    unlock: "EV",
    blurb: "Burns superheated steam and exhausts plain steam 1:1.",
    turbineClass: "steam",
    xl: false,
    steamGrade: "SH Steam",
  },
  {
    ...
    unlock: "UHV",
    blurb: "Burns supercritical steam and exhausts superheated steam 1:1.",
    turbineClass: "steam",
    xl: false,
    steamGrade: "SC Steam",
  },
  {
    ...
    unlock: "LuV",
    blurb: "Sixteen turbines in one; takes dense steam too.",
    turbineClass: "steam",
    xl: true,
    steamGrade: "select",
  },
  {
    ...
    unlock: "EV",
    blurb: "Benzene and friends at rotor efficiency.",
    turbineClass: "gas",
    xl: false,
  },
  {
    ...
    unlock: "LuV",
    blurb: "Sixteen gas turbines in one block.",
    turbineClass: "gas",
    xl: true,
  },
  {
    ...
    unlock: "LuV",
    blurb: "Turns fusion plasma into EU and its cooled gas.",
    turbineClass: "plasma",
    xl: false,
  },
  {
    ...
    unlock: "ZPM",
    blurb: "Sixteen plasma turbines; weak plasmas derate it hard.",
    turbineClass: "plasma",
    xl: true,
  },
];
